...
describe('ycb unit tests', function () {
    ...
    describe('_processRawBundle', function () {
        it('should set up settings and dimensions', function () {
            var bundle, ycb;
            bundle = readFixtureFile('dimensions.json').concat(readFixtureFile('simple-1.json')[0]);
            ycb = new libycb.Ycb(bundle);
        ...
        it('should not break if there are no dimensions', function () {
            var bundle, ycb;
            bundle = readFixtureFile('simple-1.json').concat(readFixtureFile('simple-3.json'));
            ycb = new libycb.Ycb(bundle);
    ...
    describe('read', function () {
        ...
        it('should correctly read simple config with dimensions', function () {
            var bundle, config;
            bundle = readFixtureFile('dimensions.json').concat(readFixtureFile('simple-1.json'));
            config = libycb.read(bundle);
        ...
        it('should merge matched settings', function () {
            ...
            bundle = readFixtureFile('dimensions.json').concat(readFixtureFile('simple-4.json'));
            ycb = new libycb.Ycb(bundle);
            var config = ycb.read({
                lang: 'fr',
            });
        ...
        it('should not merge matched settings', function () {
            ...
            bundle = readFixtureFile('dimensions.json').concat(readFixtureFile('overridden-multisetting.json'));
            ycb = new libycb.Ycb(bundle);
            var config = ycb.read({
                lang: 'fr',
            });
    ...
    describe('getCacheKey', function () {
        ...
        it('should map equivalent contexts to same key', function () {
            ...
            cacheKeyChecker(ycb, {
                expect: '[0,0,0]',
                contexts: [{}, { lang: 'en' }, { region: 'xanadu' }, { bucket: '101' }],
            });
            ...
            cacheKeyChecker(ycb, {
                expect: '[1,0,0]',
                contexts: [{ lang: 'fr' }, { lang: 'fr_FR' }, { lang: 'fr_CA' }],
            });
        });
    });
